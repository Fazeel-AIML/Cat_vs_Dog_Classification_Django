...
SECRET_KEY = 'django-insecure-u_c_^#g3*&ghs+*2y9=8d@op-ak(+xh=h37$d6gflc40rkqezo'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'D:\Programming\Html Files\Websites\Test\Classification\static'),
]
